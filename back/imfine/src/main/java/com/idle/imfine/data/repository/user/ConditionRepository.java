...
public interface ConditionRepository extends JpaRepository<Condition, Long> {
    ...
    @Query("select c from Condition c where c.date=:now and c.user.id in :commentUsers")
    List<Condition> findConditionsByDateAndUserIn(@Param("now") LocalDate now, @Param("commentUsers") List<Long> commentsUsers);
